...
using System;
using System.Linq;
using Fabrikam.AI.Bot.Dialogs.Main.Resources;
using Fabrikam.AI.Bot.Middleware;
using Fabrikam.AI.Bot.Middleware.Telemetry;
...
namespace Fabrikam.AI.Bot
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddBot<Fabrikam.AI.Bot>(options =>
            {
                // Load the connected services from .bot file.
