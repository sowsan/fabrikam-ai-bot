...
```shell
msbot clone services --name "Fabrikam.AI.Bot" --luisAuthoringKey "YOUR_AUTHORING_KEY" --folder "DeploymentScripts\YOUR_LOCALE_FOLDER" --location "westus"
```
...
```shell
az bot publish --name "Fabrikam.AI.Bot" --resource-group "Fabrikam.AI.Bot"
```
